(function (window) {
    ...
    var researchProjects = [
        {
            ...
            imageCaption: "???",
            imageTitle: "Image title Engineering thermal properties in MOFs",
    ...
    //TODO come back to this after usage gets fleshed out
    //Maybe could deliver data.js to server then call parts?  but it is export form.....
    window.app.rawData = researchProjects[0];
    console.log('window.app.rawData', window.app.rawData);
